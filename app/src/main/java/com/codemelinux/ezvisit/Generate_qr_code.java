       ...
       // unitNo = (TextInputEditText) view.findViewById(R.id.unitNo);
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(getActivity(), android.R.style.Theme_Holo_Light_Dialog_MinWidth,
                        mTimeSetListener,
                        hour, minute, true);
                            ...
                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (document.exists()) {
                                        ...
                                        VisitorClass visitorClass = new VisitorClass(name.getText().toString(), mobileNo.getText().toString(), icNo.getText().toString(), vehNo.getText().toString(),unitNo,time.getText().toString(),date.getText().toString(), photoUrl);
